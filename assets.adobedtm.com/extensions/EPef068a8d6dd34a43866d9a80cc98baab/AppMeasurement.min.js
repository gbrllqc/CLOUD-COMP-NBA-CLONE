...
function AppMeasurement(e) {
    ...
    t.log = function(e) {
        ...
        if (o || (o = t.d.webkitVisibilityState), o && "prerender" == o) {
            if (!t.ka)
                for (t.ka = 1, a = 0; a < c.length; a++) t.d.addEventListener(c[a], (function() {
            ...
            for (o in n)
                if (!(Object.prototype[o] || r && o.substring(0, r.length) != r) && n[o] && (!a || 0 <= a.indexOf("," + (i ? i + "." : "") + o + ","))) {
                    ...
                    if (!s && ("" == u && (u += "&" + e + "."), c = n[o], r && (o = o.substring(r.length)), 0 < o.length))
                        if (0 < (s = o.indexOf("."))) s = (r || "") + (c = o.substring(0, s)) + ".", f || (f = []), f.push(s), u += t.l(c, n, a, i, s);
        ...
        var n, a;
        for (n in t.S)
            if (!Object.prototype[n] && (a = t.S[n]) && (a._olc && a.onLoad && (a._olc = 0, a.onLoad(t, a)), a[e] && a[e]())) return 1;
        return 0
    }, t.hc = function() {
        ...
        var a, i, r, o, c, s, l;
        for (l = {}, a = 0; 2 > a; a++)
            for (i = 0 < a ? t.Na : t.i, r = 0; r < i.length; r++)
                if ((c = e[o = i[r]]) || e["!" + o]) {
        ...
        var e;
        if (t.isReadyToTrack() && (t.Nb(), t.j != a))
            for (; 0 < t.j.length;)(e = t.j.shift()).Tb.apply(e.Ub, e.Rb)
    }, t.Nb = function() {
        ...
        if ("object" == typeof e.dests)
            for (var n = 0; n < e.dests.length; ++n) {
                ...
                if ("string" == typeof a.c && "aa." == a.id.substr(0, 3))
                    for (var i = a.c.match(t.sc), r = 0; r < i.length; ++r) {
                        var o = i[r],
                            c = o.match(t.gb),
                            s = "";
        ...
        if ("object" == typeof e)
            if (t.Zb(e), "object" == typeof t.AudienceManagement && "function" == typeof t.AudienceManagement.isReady && t.AudienceManagement.isReady() && "function" == typeof t.AudienceManagement.passData) t.AudienceManagement.passData(e);
        ...
        if (!t.p || (t.A && t.A.complete && t.A.D && t.A.T(), !t.p))
            if (t.Wa = a, t.ra) t.na > t.P && t.cb(t.g), t.va(500);
            else {
                var e = t.Sb();
    ...
    for (o && "y" == o.x ? (t.Z = !0, t.Y = function(e) {
            ...
            if (t.zb(e) && (r = 1, i = {
                ...
                }, t.ab = t.B(), 1 === r) i.send(e);
            else if (2 === r) o = e.indexOf("?"), r = e.substring(0, o), o = (o = e.substring(o + 1)).replace(/&callback=[a-zA-Z0-9_.\[\]]+/, ""), i.open("POST", r, !0), i.withCredentials = !0, i.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), i.send(o);
            else if (i.src = e, 3 === r) {
                if (t.Za) try {
                    o.removeChild(t.Za)
                } catch (e) {}
            ...
            if (t.trackOffline)
                for ((!t.offlineLimit || 0 >= t.offlineLimit) && (t.offlineLimit = 10); t.g.length > t.offlineLimit;) t.Ta()
            ...
            var n, a, i;
            for (t.nc = e, n = 0; n < t._il.length; n++)
    ...
    i = "pe pev1 pev2 pev3 latitude longitude resolution colorDepth javascriptVersion javaEnabled cookiesEnabled browserWidth browserHeight connectionType homepage pageURLRest marketingCloudOrgID ms_a".split(" "), t.i = t.i.concat(i), t.F = t.F.concat(i), t.ssl = 0 <= n.location.protocol.toLowerCase().indexOf("https"), t.charSet = "UTF-8", t.contextData = {}, t.wa = ["architecture", "bitness", "model", "platformVersion", "wow64"], t.writeSecureCookies = !1, t.collectHighEntropyUserAgentHints = !1, t.offlineThrottleDelay = 0, t.storageFilename = "AppMeasurement.requests", t.R = "s_sq", t.ab = 0, t.na = 0, t.P = 0, t.$a = 0, t.linkDownloadFileTypes = "exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx", t.w = n, t.d = n.document, t.ha = function() {
        ...
        t.b = t.d.body, t.b ? (t.u = function(e) {
            ...
            if (!(t.d && t.d.getElementById("cppXYctnr") || e && e["s_fe_" + t._in])) {
                ...
                try {
                    if (!t.clickObject || t.O && t.O == t.clickObject || !(t.clickObject.tagName || t.clickObject.parentElement || t.clickObject.parentNode)) t.clickObject = 0;
                    else {
...
function s_pgicq() {
    var e, t, n, a = window,
        i = a.s_giq;
    if (i)
        for (e = 0; e < i.length; e++)(n = s_gi((t = i[e]).oun)).setAccount(t.un), n.setTagContainer(t.tagContainerName);
    a.s_giq = 0
}
