var OneTrustStub = (t => {
    ...
    function u(n, a) {
        ...
        return l.next = t(0), l.throw = t(1), l.return = t(2), "function" == typeof Symbol && (l[Symbol.iterator] = function() {
            return this
        }), l;
                ...
                for (; u = l && e[l = 0] ? 0 : u;) try {
                    ...
                    switch (s = 0, (e = r ? [2 & e[0], r.value] : e)[0]) {
                        ...
                        case 7:
                            ...
                            continue;
                        default:
                            if (!(r = 0 < (r = u.trys).length && r[r.length - 1]) && (6 === e[0] || 2 === e[0])) {
                                u = 0;
                                continue
                            }
                            if (3 === e[0] && (!r || e[1] > r[0] && e[1] < r[3])) u.label = e[1];
                            else if (6 === e[0] && u.label < r[1]) u.label = r[1], r = e;
                            else {
                                if (!(r && u.label < r[2])) {
                                    r[2] && u.ops.pop(), u.trys.pop();
                                    continue
                                }
                                u.label = r[2], u.ops.push(e)
                            }
                    }
                    e = a.call(n, u)
                } catch (t) {
    ...
    function h() {
        ...
        this.implementThePolyfill = function() {
            ...
            return Element.prototype.setAttribute = function(t, e) {
                var i = "string" == typeof t ? t.toLowerCase() : "";
                if ("style" !== i && s.apply(this, [t, e]), "style" !== i || e || this.removeAttribute("style"), "style" === i && e) {
                    this.removeAttribute("style");
                    var n, a = o.strToObj(e);
                    for (n in a) this.style[n] = a[n]
                }
            }, !0
        }
    }
    ...
    }(n = r = r || {}).ping = "ping", n.addEventListener = "addEventListener", n.removeEventListener = "removeEventListener", n.hasSection = "hasSection", n.getSection = "getSection", n.getField = "getField", n.getGPPData = "getGPPData";
    var g = new function() {
            var s = this;
        ...
        f = (A.initCSPTrustedType = function(t) {
            var n = new URL(t, location.origin);
        ...
        }, A.createScriptURL = function(t) {
            return A.isCspTrustedType() ? window.OtTrustedType.TrustedTypePolicy.createScriptURL(t) : t
        }, A.checkAndAssignCspTrustedTypeEnabled = function(t) {
    ...
    function A() {}
    b.prototype.initConsentSDK = function() {
        this.initCustomEventPolyfill(), this.setStubScriptElement(), this.setOTDataLayer(), this.getParam(), this.fetchBannerSDKDependency(), this.captureNonce(), this.captureShopify()
    }, b.prototype.captureNonce = function() {
        this.nonce = c.stubScriptElement.nonce || c.stubScriptElement.getAttribute("nonce") || null
    }, b.prototype.captureShopify = function() {
        this.isShopify = c.stubScriptElement.hasAttribute("data-shopify-consent-mapping")
    }, b.prototype.fetchBannerSDKDependency = function() {
        this.setDomainDataFileURL(), this.crossOrigin = c.stubScriptElement.getAttribute("crossorigin") || null, this.previewMode = "true" === c.stubScriptElement.getAttribute("data-preview-mode"), this.otFetch(c.bannerDataParentURL, this.getLocation.bind(this))
    }, b.prototype.setDomainIfBulkDomainEnabled = function(t) {
        ...
        e && e.CookieV2BulkDomainManagement && i !== n && t.ScriptType === p && ((e = window.sessionStorage) && e.getItem("bulkDomainMgmtEnabled") ? this.handleBulkDomainMgmt({
            ...
            location: c.storageBaseURL.replace(/^https?:\/\//, ""),
            domainId: this.domainId,
            url: i
        }, this.otFetch(a, this.handleBulkDomainMgmt, !1, n, t)))
    }, b.prototype.getLocation = function(t) {
        if (this.setDomainIfBulkDomainEnabled(t), this.updateVersion(t), this.subDomainEnabled = t.SubDomainEnabled || !1, this.domainHashValue = t.DomainHashValue || "", this.scriptType = t.ScriptType || "", this.ensureHtmlGroupDataInitialised(), (t.TenantFeatures && t.TenantFeatures.CookieV2CSP || t.CookieV2CSPEnabled) && this.nonce && (this.setAttributePolyfillIsActive = !0, (new d).implementThePolyfill()), f.checkAndAssignCspTrustedTypeEnabled(t) && f.initCSPTrustedType(c.storageBaseURL), !t.RuleSet[0].Type) return this.iabTypeAdded = !1, window.__tcfapi = this.executeTcfApi, this.intializeIabStub(), this.addBannerSDKScript(t);
        var e, i = window;
        i.OneTrust && i.OneTrust.geolocationResponse ? (i = i.OneTrust.geolocationResponse, this.setGeoLocation(i.countryCode, i.stateCode, i.stateName), this.addBannerSDKScript(t)) : (i = this.readCookieParam(c.optanonCookieName, c.geolocationCookiesParam)) || t.SkipGeolocation ? (e = i.split(";")[0], i = i.split(";")[1], this.setGeoLocation(e, i), this.addBannerSDKScript(t)) : this.getGeoLocation(t)
    }, b.prototype.handleBulkDomainMgmt = function(t, e) {
    ...
    }, b.prototype.getGeolocationURL = function(t) {
        t.TenantFeatures;
        var e = "" + c.stubScriptElement.getAttribute("src").split(c.stubFileName)[0] + t.Version;
        return new RegExp("^file://", "i").test(e) && t.MobileSDK ? (e = "/" + t.GeolocationUrl.replace(/^(http|https):\/\//, "").split("/").slice(1).join("/") + ".js", c.storageBaseURL + e) : t.GeolocationUrl
    }, b.prototype.geoLocationJsonCallback = function(t, e) {
        e && this.setGeoLocation(e.country, e.state, e.stateName), this.addBannerSDKScript(t)
    }, b.prototype.getGeoLocation = function(t) {
        var e = this.getGeolocationURL(t);
        this.otFetch(e, this.geoLocationJsonCallback.bind(this, t), !0)
    }, b.prototype.setOTDataLayer = function() {
        var t = "data-dLayer-ignore",
            e = c.stubScriptElement.hasAttribute(t),
            t = c.stubScriptElement.getAttribute(t);
        this.otDataLayer = {
            ignore: e && "true" === t || e && "" === t,
            name: c.stubScriptElement.getAttribute("data-dLayer-name") || "dataLayer"
        }
    }, b.prototype.setGeoLocation = function(t, e, i) {
        c.userLocation = {
            country: t,
            state: e = void 0 === e ? "" : e,
            stateName: i = void 0 === i ? "" : i
        }
    }, b.prototype.otFetch = function(t, i, e, n, a) {
    ...
    }, b.prototype.otFetchOfflineFile = function(t, e) {
        var i = (t = t.replace(".json", ".js")).split("/"),
            n = i[i.length - 1].split(".js")[0];
        this.jsonp(t, function() {
            e(window[n])
        })
    }, b.prototype.jsonp = function(t, e, i, n) {
        void 0 === i && (i = !1), void 0 === n && (n = "");
        var a = document.createElement("script"),
            o = f.createScriptURL(t);
        a.setAttribute("src", o), this.nonce && a.setAttribute("nonce", this.nonce), a.async = !0, a.type = "text/javascript", i && n && (a.integrity = n), this.crossOrigin && a.setAttribute("crossorigin", this.crossOrigin), document.getElementsByTagName("head")[0].appendChild(a), new RegExp("^file://", "i").test(t) || c.mobileOnlineURL.push(t), e && (a.onload = a.onerror = function() {
            e()
        })
    }, b.prototype.getRegionSet = function(t) {
        var e, i, n, a = c.userLocation,
    ...
    }, b.prototype.validateIABGDPRApplied = function() {
    ...
    }, b.prototype.isBoolean = function(t) {
        return "true" === t || "false" === t
    }, b.prototype.readCookieParam = function(t, e) {
        ...
        return ""
    }, b.prototype.getCookieNameSuffix = function() {
        return this.scriptType === p && this.subDomainEnabled && this.domainHashValue ? "_" + this.domainHashValue : ""
    }, b.prototype.getCookie = function(t) {
        if (this.isAmp) {
            var e = JSON.parse(window.localStorage.getItem(this.domainId)) || {};
            if (e) return e[t] || null
        }
        for (var i = "" + t + this.getCookieNameSuffix() + "=", n = 0, a = document.cookie.split(";"); n < a.length; n++) {
            var o = a[n].trim();
            if (0 === o.indexOf(i)) return o.substring(i.length)
        }
        return null
    }, b.prototype.updateGtmMacros = function() {
        for (var t = [], e = c.optanonHtmlGroupData.length, i = 0; i < e; i++) this.endsWith(c.optanonHtmlGroupData[i], ":1") && t.push(c.optanonHtmlGroupData[i].replace(":1", ""));
        for (e = c.optanonHostData.length, i = 0; i < e; i++) this.endsWith(c.optanonHostData[i], ":1") && t.push(c.optanonHostData[i].replace(":1", ""));
        for (e = c.genVendorsData.length, i = 0; i < e; i++) this.endsWith(c.genVendorsData[i], ":1") && t.push(c.genVendorsData[i].replace(":1", ""));
        for (e = c.vendorsServiceData.length, i = 0; i < e; i++) this.endsWith(c.vendorsServiceData[i], ":1") && t.push(c.vendorsServiceData[i].replace(":1", ""));
    ...
    }, b.prototype.deserialiseStringToArray = function(t) {
        return t ? t.split(",") : []
    }, b.prototype.endsWith = function(t, e) {
        return -1 !== t.indexOf(e, t.length - e.length)
    }, b.prototype.serialiseArrayToString = function(t) {
        return t.toString()
    }, b.prototype.getStubQueryParam = function(t, e) {
        return !t || (t = t.split("?")).length < 2 ? null : new URLSearchParams(t[1]).get(e)
    }, b.prototype.setStubScriptElement = function() {
        c.stubScriptElement = document.querySelector("script[src*='" + c.stubFileName + "']");
        var t = c.stubScriptElement && c.stubScriptElement.getAttribute("src"),
    ...
    }, b.prototype.setDomainDataFileURL = function() {
        var t = c.stubScriptElement.getAttribute("src"),
            e = -1 < t.indexOf("/consent");
        t && (c.isMigratedURL ? c.storageBaseURL = t.split("/consent/" + c.migratedCCTID)[0] : c.storageBaseURL = (e ? t.split("/consent") : t.split("/scripttemplates/" + c.stubFileName))[0]), this.storageBaseURL = c.storageBaseURL, this.isPreview && -1 === this.domainId.indexOf("test") ? this.domainId = this.domainId + "-test" : this.isPreview = !1, c.bannerBaseDataURL = c.storageBaseURL && c.storageBaseURL + "/consent/" + this.domainId, c.bannerDataParentURL = c.bannerBaseDataURL + "/" + this.domainId + ".json"
    }, b.prototype.initCustomEventPolyfill = function() {
        ...
        var t = "true" === this.urlParams.get("otreset"),
            ...
            i = (this.geoFromUrl = (this.urlParams.get("otgeo") || "").toLowerCase(), this.readCookieParam(l, "expiry")),
            n = this.readCookieParam(l, s);
    ...
    function b() {
        ...
        this.iabType = null, this.iabTypeAdded = !0, this.crossOrigin = null, this.isAmp = !1, this.domainId = "", this.isReset = !1, this.isPreview = !1, this.geoFromUrl = "", this.nonce = "", this.setAttributePolyfillIsActive = !1, this.storageBaseURL = "", this.charset = null, this.isShopify = !1, this.subDomainEnabled = !1, this.domainHashValue = "", this.scriptType = "", this.buildType = "undefined", this.addBannerSDKScript = function(s) {
                    ...
                    switch (t.label) {
                        ...
                        case 3:
                            return window.otStubData = {
                                ...
                                stubUrl: c.stubScriptElement.getAttribute("src"),
                                sriHash: a,
                                isShopify: this.isShopify
                            }, this.jsonp(n, null, !0, null == (o = a) ? void 0 : o["otBannerSdk.js"]), [2]
                    }
                })
            })
        }, this.fetchSriHash = function(i) {
            return e(r, void 0, void 0, function() {
                var e;
                return u(this, function(t) {
                    switch (t.label) {
                        case 0:
                            return t.trys.push([0, 4, , 5]), [4, fetch(i)];
                        case 1:
                            return (e = t.sent()).ok ? [4, e.json()] : [3, 3];
                        case 2:
                            return [2, t.sent()];
                        case 3:
                            return [3, 5];
                        case 4:
                            return e = t.sent(), console.error("Error fetching SRI hash:", e), [3, 5];
                        case 5:
                            return [2, null]
                    }
                })
            ...
            var t = window;
            r.iabTypeAdded ? (void 0 === t.__tcfapi && (window.__tcfapi = r.executeTcfApi), r.addIabFrame()) : r.addBackwardIabFrame(), t.receiveOTMessage = r.receiveIabMessage, (t.attachEvent || window.addEventListener)("message", t.receiveOTMessage, !1)
        }, this.addIabFrame = function() {
            var t = window,
                e = "__tcfapiLocator";
            !t.frames[e] && (t.document.body ? r.addLocator(e, "CMP") : setTimeout(r.addIabFrame, 5))
        }, this.addBackwardIabFrame = function() {
            var t = window,
                e = "__tcfapiLocator";
            !t.frames[e] && (t.document.body ? r.addLocator(e, "TCF") : setTimeout(r.addIabFrame, 5))
        }, this.addLocator = function(t, e) {
            var i = window,
                n = i.document.createElement("iframe");
            m(n, "display: none;", !0), n.name = t, n.setAttribute("title", e + " Locator"), i.document.body.appendChild(n)
        }, this.receiveIabMessage = function(i) {
            var n, a, t, o = "string" == typeof i.data,
                e = {};
            try {
                e = o ? JSON.parse(i.data) : i.data
            } catch (t) {}
            e.__cmpCall && "IAB2" === r.iabType && console.log("Expecting IAB TCF v2.0 vendor iFrame call; Received IAB TCF v1.1"), e.__tcfapiCall && "IAB2" === r.iabType && (n = e.__tcfapiCall.callId, a = e.__tcfapiCall.command, t = e.__tcfapiCall.parameter, e = e.__tcfapiCall.version, r.executeTcfApi(a, t, function(t, e) {
                t = {
                    __tcfapiReturn: {
                        returnValue: t,
                        success: e,
            ...
            for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
            if (r.iabType = "IAB2", !t.length) return window.__tcfapi.a || [];
            var i = t[0],
                n = t[1],
                a = t[2],
                o = t[3];
            "function" == typeof a && i && ("ping" === i ? r.getPingRequest(a) : r.addToQueue(i, n, a, o))
            ...
            var i, n;
            t && (n = !(i = {}), "IAB2" !== r.iabType && "IAB2V2" !== r.iabType || (i = {
    ...
    var S = new y;
    return t.OtSDKStub = y, t.otSdkStub = S, Object.defineProperty(t, "__esModule", {
        value: !0
    }), t
})({});