...
import {
    Observable
} from '#core/data-structures/observable';
import {
    Deferred
} from '#core/data-structures/promise';
import {
    Signals
} from '#core/data-structures/signals';
import {
    isDocumentReady,
    whenDocumentReady
...
import {
    parseQueryString
} from '#core/types/string/url';
import {
    WindowInterface
} from '#core/window/interface';
...
export class AmpDoc {
    ...
    constructor(win, parent, opt_options) {
        ...
        devAssert(!paramsVisibilityState ||
    ...
    declareExtension(extensionId, version) {
        devAssert(!this.declaredExtensions_[extensionId] ||
