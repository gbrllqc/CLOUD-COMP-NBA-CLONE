...
} from '#service/document-info-impl';
import {
    installHiddenObserverForDoc
} from '#service/hidden-observer-impl';
import {
...
import {
    installUrlForDoc
} from '#service/url-impl';
import {
    installUrlReplacementsServiceForDoc
} from '#service/url-replacements-impl';

import {
    installInaboxCidService
} from './inabox-cid';
import {
    installIframeMessagingClient
} from './inabox-iframe-messaging-client';
import {
    installInaboxMutatorServiceForDoc
} from './inabox-mutator';
import {
    installInaboxResourcesServiceForDoc
} from './inabox-resources';
import {
    installInaboxViewerServiceForDoc
} from './inabox-viewer';
import {
    installInaboxViewportService
} from './inabox-viewport';
