...
} from '#service/platform-impl';

import {
    installAmpdocServicesForInabox
} from './inabox-services';
import {
    maybeRenderInaboxAsStoryAd
} from './inabox-story-ad';
import {
    getA4AId,
    registerIniLoadListener
} from './utils';

import {
    cssText as ampSharedCss
} from '../../build/ampshared.css';
import {
