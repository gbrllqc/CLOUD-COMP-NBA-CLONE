...
import {
    makeClickDelaySpec
} from './filters/click-delay';
import {
    createFilter
} from './filters/factory';
import {
    FilterType
} from './filters/filter';
import {
    makeInactiveElementSpec
} from './filters/inactive-element';
        ...
        try {
            ...
            for (const name in config['targets']) {
                ...
                for (const customVar in target['vars']) {
                    ...
                    const {
                        origin
                    } = parseUrlDeprecated(assertVendor(vendor));
